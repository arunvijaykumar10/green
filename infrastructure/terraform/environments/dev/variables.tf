...
variable "public_domain_name" {
  ...
  type        = string
  default     = "greenroom-dev.tabletoplabs.studio"
}

variable "private_domain_name" {
  description = "Private domain name for the hosted zone"
  type        = string
  default     = "greenroom-dev.internal"
}
...
variable "dns_force_destroy" {
  description = "Allow destruction of hosted zones (useful for dev)"
  type        = bool
...
variable "db_instance_class" {
  ...
  type        = string
  default     = "db.t4g.micro"  # Smallest instance for cost optimization
}
...
variable "db_backup_retention_period" {
  ...
  type        = number
  default     = 1  # Minimal backup retention for dev
}
...
variable "ecr_max_image_count" {
  ...
  type        = number
  default     = 10  # Lower for dev environment
}
...
variable "cache_node_type" {
  ...
  type        = string
  default     = "cache.t4g.micro"  # Smallest for dev
}
...
variable "cache_transit_encryption_enabled" {
  ...
  type        = bool
  default     = false  # Disabled for simplicity in dev
}
...
variable "ecs_cpu" {
  ...
  type        = number
  default     = 256  # Minimal for dev
}

variable "ecs_memory" {
  description = "Memory (MB) for the ECS task"
  type        = number
  default     = 512  # Minimal for dev
}
...
variable "ecs_max_capacity" {
  ...
  type        = number
  default     = 3  # Limited scaling for dev
}
...
variable "cognito_mfa_configuration" {
  ...
  type        = string
  default     = "OFF"  # Disabled for dev simplicity
}
