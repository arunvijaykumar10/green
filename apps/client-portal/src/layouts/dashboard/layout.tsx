...
function DashboardLayout({
  ...
  // Use custom nav data or dynamic nav data based on user role
  const navData = React.useMemo(() => slotProps?.nav?.data ?? dynamicNavData, [slotProps?.nav?.data, dynamicNavData]);
